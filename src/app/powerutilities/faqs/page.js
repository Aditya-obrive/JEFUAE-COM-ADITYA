...
export default function PowerUtilitiesFaqsPage() {
  return <RenewableEnergyFaq faqItems={powerUtilityFaqs} title="POWER UTILITIES — FAQS" backLabel="BACK TO POWER UTILITIES" backPath="/powerutilities" />;
}
