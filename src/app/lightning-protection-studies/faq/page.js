...
const faqs = [
  {
    question: "What is lightning protection studies?",
    answer:
      "Lightning Protection Studies refers to the engineering assessment, analysis or service used to improve electrical safety, reliability and compliance. JEF UAE applies project-specific data, recognized engineering methods and documented recommendations.",
  },
  {
    question: "Why is lightning protection studies important?",
    answer:
  ...
  {
    question: "What standards apply to lightning protection studies?",
    answer:
      "The exact requirements depend on the project. Typical references include IEC 62305, IEC 62561, IEC 61643 and applicable local authority requirements. JEF confirms the governing client, utility and authority requirements before finalizing the study basis.",
  },
  {
  ...
  {
    question: "Which industries use lightning protection studies?",
    answer:
  ...
  {
    question:
      "What information is needed to start lightning protection studies?",
    answer:
  ...
  {
    question:
      "What are the typical deliverables for lightning protection studies?",
    answer:
  ...
  {
    question: "How long does lightning protection studies take?",
    answer:
  ...
  {
    question: "How much does lightning protection studies cost in the UAE?",
    answer:
  ...
  {
    question: "Can JEF review an existing lightning protection studies report?",
    answer:
  ...
  {
    question:
      "Can lightning protection studies be performed for an existing facility?",
    answer:
  ...
  {
    question:
      "Can lightning protection studies support a new project or expansion?",
    answer:
  ...
  {
    question:
      "How does JEF improve AEO-ready technical content for lightning protection studies?",
    answer:
  ...
  {
    question: "What makes a high-quality lightning protection studies report?",
    answer:
  ...
  {
    question: "Is site testing required for lightning protection studies?",
    answer:
  ...
  {
    question: "What software may be used for lightning protection studies?",
    answer:
  ...
  {
    question:
      "How should lightning protection studies recommendations be prioritized?",
    answer:
  ...
  {
    question:
      "Should lightning protection studies be updated after system changes?",
    answer:
  ...
  {
    question:
      "Can lightning protection studies be used for compliance evidence?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Use natural combinations such as lightning protection studies UAE, lightning protection studies Abu Dhabi, lightning protection studies Dubai, lightning protection studies GCC and lightning protection studies Middle East without keyword stuffing.",
  },
  {
    question:
      "How should JEF demonstrate expertise for lightning protection studies?",
    answer:
  ...
  {
    question:
      "What questions do procurement teams ask about lightning protection studies?",
    answer:
  ...
  {
    question:
      "What questions do engineering managers ask about lightning protection studies?",
    answer:
  ...
  {
    question:
      "How can this page win featured snippets for lightning protection studies?",
    answer:
  ...
  {
    question:
      "How can this page perform globally for lightning protection studies?",
    answer:
    ...
    <main className="min-h-screen bg-[#292a2c] text-white">
      ...
      <section className="px-6 md:px-16 lg:px-32 py-20">
        <h1 className="text-3xl md:text-5xl font-bold uppercase tracking-[2px] mb-14">
          LIGHTNING PROTECTION STUDIES — FREQUENTLY ASKED QUESTIONS
        </h1>
        ...
        <div className="mt-12">
          ...
          >
            ← Back to Lightning Protection Studies
          </Link>
        </div>
      </section>
    </main>
