...
const EmiEmc = () => {
  ...
  const navItems = [
    ...
    { label: "SERVICES", isActive: true, href: "/emi-emc" },
  ...
  const components = [
    ...
    },
    {
      ...
      description2:
        "Recommendations for improving shielding to ensure system reliability.",
    },
    {
      imageSrc: "./SerivePage/03.png",
      title: "Grounding and Bonding Assessments",
      description:
        "Evaluation of grounding and bonding systems to minimize electromagnetic emissions.",
      description2:
        "Design recommendations for improving system grounding, ensuring compatibility with sensitive devices.",
    },
    {
      imageSrc: "./SerivePage/04.png",
      title: "EMC Compliance Testing",
      description:
        "Conducting tests to ensure equipment and systems comply with international EMC standards such as IEC 61000.",
      description2:
        "Providing actionable insights for achieving regulatory compliance.",
    },
    {
      imageSrc: "./SerivePage/05.png",
      title: "Mitigation Solutions",
      description:
        "Tailored solutions for mitigating EMI issues, including filtering, shielding, and redesigning system layouts.",
      description2:
        "Implementation of advanced techniques to enhance electromagnetic compatibility.",
    },
    {
      imageSrc: "./SerivePage/06.png",
      title: "Simulation and Modelling",
      description:
        "Utilizing cutting-edge tools for simulating electromagnetic environments and analyzing interference patterns.",
    ...
    <>
      ...
      <section className="flex overflow-hidden h-screen flex-col bg-white">
        <div className="flex relative flex-col w-full h-screen max-md:pb-24 max-md:max-w-full">
          ...
          {/* Hero Content - Responsive so long headings stay inside viewport */}
          <div className="flex Y-axis-text-Title-Service1 absolute bottom-24 left-0 right-0 mx-auto w-full max-w-[1400px] px-6 sm:px-10 lg:px-16 flex-col self-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider leading-tight text-white max-w-[1200px] break-words">
              EMI EMC ENGINEERING STUDIES AND TROUBLESHOOTING IN UAE
            </h1>
      ...
      <section className="flex h-auto -mb-11 md:mb-0 overflow-hidden flex-col bg-stone-900">
        ...
        <div className="ContactUsAnimation flex justify-center items-end self-center px-80 mt-24 max-w-full min-h-[80px] w-[770px] max-md:px-5 max-md:mt-10">
          <img
            loading="lazy"
            src="./SerivePage/EMIEMCLogo.png"
            alt="JEF EMI EMC Studies logo"
        ...
        <header className="flex p-4 ContactUsAnimation flex-col items-center self-center mt-10 w-full text-base text-center text-white max-w-[1391px] max-md:mt-10 max-md:max-w-full">
          ...
          <p className="self-stretch mt-12 w-[80%] lg:w-[60%] text-center mx-auto font-light max-md:mt-10 max-md:max-w-full">
            In an era of rapidly advancing technology, maintaining
            electromagnetic compatibility is critical for the reliable operation
            of electrical systems and devices. JEF offers comprehensive EMI and
            EMC Studies to ensure that your electrical infrastructure meets
            international standards, minimizing interference risks and ensuring
            system reliability.
          </p>
        </header>
        ...
        <header className="flex p-4 ContactUsAnimation flex-col items-center self-center mt-10 w-full text-base text-center text-white max-w-[1391px] max-md:mt-10 max-md:max-w-full">
          ...
          <p className="self-stretch mt-12 w-[80%] lg:w-[60%] text-center mx-auto font-light max-md:mt-10 max-md:max-w-full">
            Corrosion of pipeline due to induced current from the Power
            Transmission Lines and cables is a major area of concern for
            pipeline operators. JEF offers comprehensive simulation studies to
            identify areas of concern and suggest mitigation strategies.
          </p>
        </header>
        ...
        <div className="flex flex-col lg:flex-row w-full xl:w-[95%] gap-5 max-md:flex-col">
          ...
          <div className="relative flex flex-col w-[56%] max-sm:h-[110vh] max-lg:h-[55vh] overflow-hidden max-md:ml-0 max-lg:w-full">
            <div
              ...
              style={{
                transform: `translateY(-${(activeIndex * 100) / 6}%)`,
              }}
            >
                      ...
                      <div className="flex h-auto flex-col w-full max-md:w-full">
                        {content.description.split("|").map((sentence, idx) => {
                          ...
                          const isSpecialSentence =
                            specialSentences.includes(trimmedSentence);
          ...
          <div className="ml-5 w-[45%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow justify-center my-[6%] max-md:mt-10 max-md:max-w-full">
              <img
                ...
                alt="EMI EMC study illustration"
