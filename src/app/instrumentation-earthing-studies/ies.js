  ...
  return (
    <ul className="flex flex-col p-4 mt-20 mx-8 w-full text-white uppercase max-w-[80.4375rem] tracking-[0.28313rem] max-md:mt-10 max-md:max-w-full">
      {standards.map((standard) => (
        ...
        >
          <div
            className={`grow shrink gap-2.5 self-stretch px-2.5 py-5 my-auto items-center  text-lg text-center ${standard.isRed ? "bg-[#FF0000]" : "border border-gray-500 border-solid"} min-h-[6.25rem] w-[9.3125rem]`}
          >
            {standard.title}
          </div>
          <div
            className={`grow shrink gap-3 self-stretch p-2.5 my-auto text-lg leading-10 ${standard.isRed ? "bg-[#FF0000]" : "border border-gray-500 border-solid"} min-h-[6.25rem] min-w-[15rem] w-[66.25rem] max-md:max-w-full`}
          >
