...
export default function RenewableEnergyFaqsPage() {
  return <RenewableEnergyFaq faqItems={renewableEnergyFaqs} title="RENEWABLE ENERGY — FAQS" backLabel="BACK TO RENEWABLE ENERGY" backPath="/renewableenergy" />;
}
