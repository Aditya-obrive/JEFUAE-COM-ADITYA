...
const faqs = [
  {
    question: "What is earthing studies?",
    answer:
      "Earthing Studies refers to the engineering assessment, analysis or service used to improve electrical safety, reliability and compliance. JEF UAE applies project-specific data, recognized engineering methods and documented recommendations.",
  },
  {
    question: "Why is earthing studies important?",
    answer:
  ...
  {
    question: "What standards apply to earthing studies?",
    answer:
  ...
  {
    question: "Does JEF provide earthing studies across the UAE?",
    answer:
  ...
  {
    question: "Which industries use earthing studies?",
    answer:
  ...
  {
    question: "What information is needed to start earthing studies?",
    answer:
  ...
  {
    question: "What are the typical deliverables for earthing studies?",
    answer:
  ...
  {
    question: "How long does earthing studies take?",
    answer:
  ...
  {
    question: "How much does earthing studies cost in the UAE?",
    answer:
  ...
  {
    question: "Can JEF review an existing earthing studies report?",
    answer:
  ...
  {
    question: "Can earthing studies be performed for an existing facility?",
    answer:
  ...
  {
    question: "Can earthing studies support a new project or expansion?",
    answer:
  ...
  {
    question:
      "How does JEF improve AEO-ready technical content for earthing studies?",
    answer:
  ...
  {
    question: "What makes a high-quality earthing studies report?",
    answer:
  ...
  {
    question: "Is site testing required for earthing studies?",
    answer:
  ...
  {
    question: "What software may be used for earthing studies?",
    answer:
  ...
  {
    question: "How should earthing studies recommendations be prioritized?",
    answer:
  ...
  {
    question: "What is the first step to engage JEF for earthing studies?",
    answer:
  ...
  {
    question: "How can earthing studies reduce project risk?",
    answer:
  ...
  {
    question: "Should earthing studies be updated after system changes?",
    answer:
  ...
  {
    question: "Can earthing studies be used for compliance evidence?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Use natural combinations such as earthing studies UAE, earthing studies Abu Dhabi, earthing studies Dubai, earthing studies GCC and earthing studies Middle East without keyword stuffing.",
  },
  {
    question: "How should JEF demonstrate expertise for earthing studies?",
    answer:
  ...
  {
    question: "What questions do procurement teams ask about earthing studies?",
    answer:
  ...
  {
    question:
      "What questions do engineering managers ask about earthing studies?",
    answer:
  ...
  {
    question: "How can this page win featured snippets for earthing studies?",
    answer:
  ...
  {
    question: "How can this page perform globally for earthing studies?",
    answer:
...
export default function EarthingStudiesFAQ() {
    ...
    <main className="min-h-screen bg-[#292a2c] text-white">
      ...
      <section className="px-6 md:px-16 lg:px-32 py-20">
        <h1 className="text-3xl md:text-5xl font-bold uppercase tracking-[2px] mb-14">
          EARTHING STUDIES — FREQUENTLY ASKED QUESTIONS
        </h1>
