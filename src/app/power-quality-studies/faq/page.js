...
const faqs = [
  {
    question: "What is power quality studies?",
    answer:
      "Power Quality Studies refers to the engineering assessment, analysis or service used to improve electrical safety, reliability and compliance. JEF UAE applies project-specific data, recognized engineering methods and documented recommendations.",
  },
  {
    question: "Why is power quality studies important?",
    answer:
  ...
  {
    question: "What standards apply to power quality studies?",
    answer:
      "The exact requirements depend on the project. Typical references include IEEE 519, IEC 61000 series, EN 50160 and applicable utility/grid-code requirements. JEF confirms the governing client, utility and authority requirements before finalizing the study basis.",
  },
  {
    question: "Does JEF provide power quality studies across the UAE?",
    answer:
  ...
  {
    question: "Which industries use power quality studies?",
    answer:
  ...
  {
    question: "What information is needed to start power quality studies?",
    answer:
  ...
  {
    question: "What are the typical deliverables for power quality studies?",
    answer:
  ...
  {
    question: "How long does power quality studies take?",
    answer:
  ...
  {
    question: "How much does power quality studies cost in the UAE?",
    answer:
  ...
  {
    question: "Can JEF review an existing power quality studies report?",
    answer:
  ...
  {
    question:
      "Can power quality studies be performed for an existing facility?",
    answer:
  ...
  {
    question: "Can power quality studies support a new project or expansion?",
    answer:
  ...
  {
    question:
      "How does JEF improve AEO-ready technical content for power quality studies?",
    answer:
  ...
  {
    question: "What makes a high-quality power quality studies report?",
    answer:
  ...
  {
    question: "Is site testing required for power quality studies?",
    answer:
  ...
  {
    question: "What software may be used for power quality studies?",
    answer:
  ...
  {
    question:
      "How should power quality studies recommendations be prioritized?",
    answer:
  ...
  {
    question: "What is the first step to engage JEF for power quality studies?",
    answer:
  ...
  {
    question: "How can power quality studies reduce project risk?",
    answer:
  ...
  {
    question: "Should power quality studies be updated after system changes?",
    answer:
  ...
  {
    question: "Can power quality studies be used for compliance evidence?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Use natural combinations such as power quality studies UAE, power quality studies Abu Dhabi, power quality studies Dubai, power quality studies GCC and power quality studies Middle East without keyword stuffing.",
  },
  {
    question: "How should JEF demonstrate expertise for power quality studies?",
    answer:
  ...
  {
    question:
      "What questions do procurement teams ask about power quality studies?",
    answer:
  ...
  {
    question:
      "What questions do engineering managers ask about power quality studies?",
    answer:
  ...
  {
    question:
      "How can this page win featured snippets for power quality studies?",
    answer:
  ...
  {
    question: "How can this page perform globally for power quality studies?",
    answer:
...
export default function PowerQualityStudiesFAQ() {
    ...
    <main className="min-h-screen bg-[#292a2c] text-white pt-32 md:pt-40">
      ...
      <section className="px-6 md:px-16 lg:px-32 py-20">
        <h1 className="text-3xl md:text-5xl font-bold uppercase tracking-[2px] mb-14">
          POWER QUALITY STUDIES — FREQUENTLY ASKED QUESTIONS
        </h1>
