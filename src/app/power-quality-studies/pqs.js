    ...
    <>
      ...
      <section className="flex overflow-hidden h-screen flex-col bg-white">
        <div className="flex relative flex-col w-full h-screen max-md:pb-24 max-md:max-w-full">
          ...
          >
            <source
              src="./SerivePage/Power Quality Banner Video.mp4"
              type="video/mp4"
            />
      ...
      <section className="flex h-auto -mb-11 md:mb-0 overflow-hidden flex-col bg-stone-900">
        ...
        <header className="ContactUsAnimation flex p-4 flex-col items-center self-center mt-10 w-full text-base text-center text-white max-w-[1391px] max-md:mt-10 max-md:max-w-full">
          ...
          <p className="self-stretch mt-12 font-light max-md:mt-10 max-md:max-w-full">
            ...
            to ensure your <br className="hidden md:block" />
            electrical systems operate efficiently and reliably. With years of
            experience and a <br className="hidden md:block" />
            team of experts, we help you identify and mitigate power quality
            issues that can <br className="hidden md:block" />
...
519, and IEC 61000.|Reducing operational costs by preventing equipment damage and minimizing downtime.`,
    ...
    {
      imgSrc:
        "https://cdn.builder.io/api/v1/image/assets/TEMP/6ea8583cc00a44231bfb61be46e3517321fdd08d7a42dfbfdc2e24?placeholderIfAbsent=true&apiKey=7904fd7afaaf4ee2b0837ab86d91b244",
    ...
    <section>
      <div className="overflow-hidden py-20 w-full bg-stone-900 max-md:pt-24 px-5 md:px-12 lg:px-0 max-md:mt-10 max-md:w-full">
        <div className="flex flex-col lg:flex-row w-full xl:w-[95%] gap-5 max-md:flex-col">
          ...
          <div
            className={`relative flex flex-col w-[56%] max-sm:h-[100vh] max-lg:h-[47vh] overflow-hidden max-md:ml-0 max-lg:w-full ${
