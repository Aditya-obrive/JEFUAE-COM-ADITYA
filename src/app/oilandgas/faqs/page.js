...
export default function OilAndGasFaqsPage() {
  return <RenewableEnergyFaq faqItems={oilAndGasFaqs} title="OIL AND GAS — FAQS" backLabel="BACK TO OIL AND GAS" backPath="/oilandgas" />;
}
