...
export default function CommercialBuildingFaqsPage() {
  return <RenewableEnergyFaq faqItems={commercialBuildingFaqs} title="COMMERCIAL BUILDINGS — FAQS" backLabel="BACK TO COMMERCIAL BUILDINGS" backPath="/commercialbuilding" />;
}
