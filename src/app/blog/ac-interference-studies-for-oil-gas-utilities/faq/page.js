...
export default function ACInterferenceFAQ() {
  ...
  return (
    <main className="min-h-screen bg-[#292a2c] text-white pt-32 md:pt-40">
      <div className="max-w-[1100px] mx-auto px-6 md:px-8 pb-20">
        {/* Back Link */}
        <Link
          href="/blog/ac-interference-studies-for-oil-gas-utilities"
        ...
        <p className="text-gray-300 text-base md:text-lg leading-relaxed max-w-4xl mb-10">
          Frequently asked questions about AC interference studies for oil and
          gas utilities, electrical safety, compliance, methodology and
